  ...
  const handleDeletar = (id) => {
    ...
    <Card>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button variant="outlined" color="inherit" onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="small" /></Button>         
                      </TableCell>
                      <TableCell align="center">
        ...
        <CardActions>
            ...
            <Button size="small" variant="contained" color="warning">Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
